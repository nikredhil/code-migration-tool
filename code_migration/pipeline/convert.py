...
from code_migration.config import SKILLS_FILE
from code_migration.config import TABLE_SCHEMA
from code_migration.pipeline.reference_runner import render_dbt
...
def convert(code: str, language: str, client=None, provider: str = "anthropic") -> str:
    ...
    if provider == "databricks":
        from code_migration.pipeline.llm import databricks_chat
