...
from code_migration.pipeline.spark_utils import get_spark, register_tables
...
def run_candidate(code: str, tables: dict[str, pd.DataFrame], backend: str = "local") -> pd.DataFrame:
    ...
    from code_migration.pipeline.safety import validate_transform_code
    ...
    if backend == "databricks_sql":
        ...
        from code_migration.pipeline.databricks_sql_runner import run_candidate_sql
    ...
    if backend == "databricks":
        ...
        from code_migration.pipeline.databricks_command_runner import run_candidate_command
